            ...
            <section className="loan-section">
               <div className="right-side">
                  <div className="small-description">
                     <h1>Visa® Platinum Rewards Credit Card</h1>
                     <h2>Great card for everyday purchases.</h2>
                     <p>
                        Our Visa® Platinum Rewards Credit Card offers the same great rewards and protections as our other credit cards, however it is designed with a lower limit to make it easy to pay off monthly.
                     </p>
                  ...
                  <ul>
                     ...
                     <li>Credit lines up to $4,999.</li>
...
export default VisaPlatiumCreditCard;
